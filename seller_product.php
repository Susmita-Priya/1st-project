	 ...
	 <?php
         include 'insert.php';
			...
			if(isset($_POST['submit']))
			{
					...
					$insertquery = "insert into product(image,id,name,price,quantity) values('$image', '$id', '$name', '$price', '$amount' )";
						$iquery =mysqli_query ($con, $insertquery);

						if($iquery){
							?>
						<script>
							alert("Product is been stroed");
						...
						?>
						<script>
							alert("product is not been stroed");
						</script>
						<?php
					}
				}
